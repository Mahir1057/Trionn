...
import technisImage from "../assets/technis-main-landscape.webp";

export default function TechnisProject() {
  return (
    <section className="w-full min-h-screen bg-black text-white flex flex-col md:flex-row items-center justify-between px-8 py-16">
      ...
      >
        ...
        <p className="text-gray-400 text-lg">UX, UI Design, Development</p>
