...
import loftloomImage from "../assets/loftloom-main-landscape.webp";

export default function LoftloomProject() {
  return (
    <section className="w-full min-h-screen bg-black text-white flex flex-col md:flex-row items-center justify-between px-8 py-16">
      ...
      <motion.div
        ...
        className="flex-1 flex flex-col justify-center items-start space-y-6 md:pr-12"
      >
        <h2 className="text-5xl md:text-7xl font-extrabold text-cyan-100">
          LOFTLOOM
        </h2>
        <p className="text-gray-400 text-lg">UI Design, UX, Wireframe</p>
